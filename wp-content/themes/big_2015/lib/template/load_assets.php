...
function site_name_enqueue_scripts(){
    ...
    wp_enqueue_style('owl', '../../bower_components/owlcar/owl-carousel/owl.carousel.css');
    ...
    // wp_enqueue_script('owl-js', '../../bower_components/owlcar/owl-carousel/owl.carousel.js', array(), '1', true);
    // wp_enqueue_script('owlee', get_bloginfo('stylesheet_directory') . '/assets/js/owl.js', array(), '1', true);
